...
public class CompanyControllerTest {
    ...
    public void testSave() throws Exception{
        ...
        mockMvc.perform(post("/company/save")
                ...
                .param("contactDetails.telephoneNumber", "453-321-321")
                .param("contactDetails.emailAddress", "super@gmail.com")
                .param("address.street", "super street")
                .param("address.buildingNumber", "22")
                .param("address.city", "Java")
                .param("address.zipCode", "1024")
                .param("address.country", "JavaLand")
        )
                .andExpect( status().isOk())
                .andExpect( view().name("company/company-details") );
